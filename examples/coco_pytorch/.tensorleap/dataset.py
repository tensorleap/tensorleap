...
def subset_images() -> List[SubsetResponse]:
    ...
    data_type = 'train2014'
    ann_file = '{}annotations/instances_{}.json'.format("coco_pytorch/ms-coco_pytorch/", data_type)
...
def input_image(idx: int, data: SubsetResponse) -> ndarray:
    ...
    filepath = "coco_pytorch/ms-coco_pytorch/{folder}/{file}".format(folder=data['subdir'], file=sample['file_name'])
