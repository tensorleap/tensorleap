...
In the digits there are some classes which are very close to each other. For example, class 1 and class 7 tends to look alike. We can see that from the population exploration plot that these samples are close 
to each other and there are some false prediction between the samples on the edge. 

- **Sample 46078:** Prediction: 1, GT: 7

<img alt="img.png" height="450" src="img.png" width="1250"/>
...
<img alt="img_1.png" height="650" src="img_1.png" width="800"/>


- **Sample 1514:** Prediction: 9, GT: 5

<img alt="img_4.png" height="500" src="img_4.png" width="1000"/>

<img alt="img_5.png" height="400" src="img_5.png" width="1250"/>
...
<img alt="img_2.png" height="500" src="img_2.png" width="650"/>
...
<img alt="img_3.png" height="450" src="img_3.png" width="1250"/>
...
<img alt="img_7.png" height="200" src="img_7.png" width="650"/>
...
<img alt="img_8.png" height="250" src="img_8.png" width="900"/>